<script>
  export let authCodeUrls;
</script>

<div class="sc-449546b7-9 jzmuak">
  <div class="login_div">
    <p>로그인 이후 이용하실 수 있습니다</p>
    {#each authCodeUrls as authCodeUrl}
      <a href={authCodeUrl.url} target="_blank" rel="opener">
        <button
          type="button"
          ...
          ><span class="css-1ihsymv"
            ...
            ></span
          >
          <p data-testid="Typography" color="#000000" class="css-m0jzil">
            {authCodeUrl.authServer}로 로그인하기
          </p></button
        >
      </a>
    {/each}
